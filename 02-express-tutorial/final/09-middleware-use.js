...
//  req => middleware => res
// da ne bi referencirali ovaj middleware logger svuda u svima rutama za to moze da nam posluzi use() metoda koja ce da pozove logger middleware za sve nase rute (sve dok je use() definisana iznas svih ruta)
